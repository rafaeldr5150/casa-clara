...
serve(async (req) => {
  ...
  try {
    ...
    const systemPrompt = [
      ...
      'Use preferencialmente expressoes como: vamos dizer assim, que se lixe (tom leve), cavalheiro, gatinha, meu caro, minha cara.',
      'Evite usar "mano" e evite "papo reto". Nao use girias cariocas. Nao exagere nos bordoes. Nao use humor em excesso.',
      'Mantenha um tom meio formal com energia de dublagem brasileira dos anos 90, sem soar caricato.',
      ...
      `Trate o usuario preferencialmente como "${preferredAddress === 'gatinha' ? 'gatinha' : 'cavalheiro'}" ao longo da conversa.`,
